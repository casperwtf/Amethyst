...
public final class TitleUpdater {
    ...
    private static final boolean SUPPORTS_19 = wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.supports(19);
    private static final Object[] DUMMY_COLOR_MODIFIERS = new Object[0];

    static {
        // Initialize classes.
        CRAFT_PLAYER = wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.getCraftClass("entity.CraftPlayer");
        CHAT_MESSAGE = SUPPORTS_19 ? null : wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.getNMSClass("network.chat", "ChatMessage");
        PACKET_PLAY_OUT_OPEN_WINDOW = wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.getNMSClass("network.protocol.game", "PacketPlayOutOpenWindow");
        I_CHAT_BASE_COMPONENT = wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.getNMSClass("network.chat", "IChatBaseComponent");
        // Check if we use containers, otherwise, can throw errors on older versions.
        CONTAINERS = useContainers() ? wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.getNMSClass("world.inventory", "Containers") : null;
        ENTITY_PLAYER = wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.getNMSClass("server.level", "EntityPlayer");
        CONTAINER = wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.getNMSClass("world.inventory", "Container");
        I_CHAT_MUTABLE_COMPONENT = SUPPORTS_19 ? wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.getNMSClass("network.chat", "IChatMutableComponent") : null;
    ...
    public static void updateInventory(Player player, String newTitle) {
        ...
        try {
            ...
            if (wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.supports(20)) {
            ...
            // Create new title.
            Object title;
            if (wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.supports(19)) {
                title = wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.toIChatBaseComponentPlain(newTitle);
            } else {
            ...
            if (container.getContainerVersion() > wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.VER && useContainers()) {
            ...
            // Send packet sync.
            wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.sendPacketSync(player, packet);
    ...
    private static boolean useContainers() {
        return wtf.casper.amethyst.paper.ryseinventory.util.ReflectionUtils.VER > 13;
    }
